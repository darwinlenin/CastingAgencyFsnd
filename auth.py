...
res = conn.getresponse()
data = res.read()
respom=json.loads(data.decode("utf-8"))
print(respom["access_token"])


headers = {
    'Content-Type': "application/json",
    'Authorization': "Bearer "+respom["access_token"]+""
    }
...
def get_token_auth_header():
    ...
    """
    auth = request.headers.get('Authorization', "Bearer "+respom["access_token"]+"")
    if not auth:
        raise AuthError({
